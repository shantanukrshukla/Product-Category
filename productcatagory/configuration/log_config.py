...
productcatagory_directory = os.path.join(current_directory, '..', '..', 'productcatagory/logs')
...
def configure_logging():
    ...
    if not logging_configured:
        ...
        os.makedirs(productcatagory_directory, exist_ok=True)
        ...
        log_file_path = os.path.join(productcatagory_directory, "productcatagory.log")

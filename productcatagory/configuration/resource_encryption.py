...
class FileDecrpytor():
    def filedecrypt(self):
        ...
        fernet = Fernet(key)
        sellercreation_directory = os.path.join(current_directory, '..', '..', 'productcatagory')
...
class ResourceEncrypt():
    ...
    def resourceEncrypt(self):
        ...
        productcatagory_directory = os.path.join(current_directory, '..', '..', 'productcatagory')
        # Specify the path to the config.ini file
        config_file_path = os.path.join(productcatagory_directory, "resource")
